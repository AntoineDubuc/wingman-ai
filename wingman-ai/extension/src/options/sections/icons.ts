/**
 * SVG Icon catalog for the options page.
 * All icons use fill="currentColor" for automatic light/dark mode support.
 */
...
/**
 * Returns an SVG icon string with the specified size.
 * Icons inherit `currentColor` for automatic theme support.
 *
 * @param name - Icon name from the catalog
